...
r_list = np.geomspace(DF.r_isco, 100*r0, N_r)
...
for i in tqdm(range(N_step)):
    ...
    df_dt_1 = DF.dfdt(r0=r0, v_orb=v0)
    DF.f_eps += df_dt_1*dt
    df_dt_2 = DF.dfdt(r0=r0, v_orb=v0)
...
plt.savefig("../plots/Density_ratio_" + DF.strID + ".pdf", bbox_inches='tight')
...
plt.savefig("../plots/Density_" + DF.strID + ".pdf", bbox_inches='tight')
